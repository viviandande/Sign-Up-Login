...
var changer = () => {
  if (document.querySelector('.wrapper1').classList.contains('a')) {
    document.title = " Sign Up ";
  } else if (document.querySelector('.wrapper2').classList.contains('b') || document.querySelector('.wrapper2').classList.contains('d')) {
    document.title = " Login ";
  } else if (document.querySelector('.wrapper3').classList.contains('c')) {
